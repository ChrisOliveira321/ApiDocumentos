...
public class DanfeProdutoParser : NotaFiscalParserBase
{

    public override string ExtrairValorTotal(string texto)
    {
        Console.WriteLine("DanfeProdutoParser: ExtrairValorTotal chamado");
    ...
    {
        Console.WriteLine("DanfeProdutoParser: ExtrairNumeroNota chamado");
    ...
    {
        Console.WriteLine("DanfeProdutoParser: ExtrairDataEmissao chamado");
